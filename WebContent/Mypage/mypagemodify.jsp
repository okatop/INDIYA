...
<input type="hidden" name="act" id="act" value="MemberModify">
						<tr>
							...
							<td class="td4"><span style="float: left;"><input
									type="text" name="id" id="id" value="" size="12"></span>
							<span style="float: left;">&emsp;</span> <span style="float: left;">
								<a href="javascript:openidcheck()"><input type="button" value="중복확인"></a></span>
									<span style="clear: left;" id="idresult" =span></span></td>
						</tr>
						<tr>
						...
						<tr id="callBackDiv">
							...
							<td class="td4"><span style="float: left;"><input
									type="text" name="zipNo" id="zipNo" value="" size="12"></span> <span
								style="float: left;">&emsp;</span> <span style="float: left;"><input
									type="button" value="우편번호검색" onclick="javascript:goPopup();"></span></td>
						</tr>
						<tr id="callBackDiv">
							<td class="td1"><center>주소</center></td>
							<td class="td3"><input type="text" name="roadAddrPart1" id="roadAddrPart1"
								value="" size="100" readonly="readonly"></td>
						</tr>

						<tr id="callBackDiv">
							<td class="td2"><center>상세주소</center></td>
							<td class="td4"><input type="text" name="addrDetail" id="addrDetail" size="100" readonly="readonly"></td>
						</tr>
					...
					<center>
						...
						<span style="float: right;">&emsp;</span> <span
							...
							<input type="button" value="회원정보수정" onclick="javascript:MemberModify();"></span>
					</center>
				</form>
	  </center>
  </main>
